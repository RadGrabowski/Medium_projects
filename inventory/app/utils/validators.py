...
def validate_integer(arg_name, arg_value, min_value=None, max_value=None, custom_min_message=None,
    ...
    Args:
        ...
        arg_value (object): the value being validated
